...
Databricks (Optional)
📂 Project Structure
bigmart-pyspark-project/ │ ├── data/ │ └── raw/ │ └── Train.csv │ ├── spark/ │ ├── ingest_data.py │ ├── data_cleaning.py │ ├── transformations.py │ └── aggregations.py │ ├── hive/ │ └── create_tables.sql │ ├── output/ │ └── parquet/ │ ├── README.md └── requirements.txt'
